...
class User {
    ...
    static async create(userData) {
        const { name, lastname, age, phone, email, password, role_id } = userData;
        const queryText = `
    ...
    `;
        const values = [name, lastname, age, phone, email, password, role_id];
    ...
    static async syncColumns() {
        ...
        for (const query of alterQueries) {
            try {
                ...
                console.error('⚠️ Error syncing column:', error.message);
            }
        }
